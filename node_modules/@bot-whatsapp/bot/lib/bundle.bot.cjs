...
var hash = { generateRef: generateRef$9, generateRefSerialize: generateRefSerialize$2 };
...
let CoreClass$1 = class CoreClass {
    ...
    handleMsg = async (messageCtxInComming) => {
        ...
        let prevMsg = await this.databaseClass.getPrevBy(from);
